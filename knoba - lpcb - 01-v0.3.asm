...
loop
        ...
        movlw   b'11110000'
        movwf     TRISC             ;Make i/o pin TRISC0 an output. Tristate register for i/o. (bcf = "bit clear f" set bit in defined register to 0 / register is "bank 1" TRISC @ h'fe' / bit mask in register is set from BSC as 0 in TRISC0 @ h'00'.
...
;        bcf     PORTC,0             ;Turn off LED @ TRISC0.
        bsf     PORTC,0             ;Turn on LED @ TRISC0.
;        bcf     PORTC,0
        bsf     STATUS,RP0          ;Select register page 1 (bsf = "bit set f" set bit in defined register to 1 / register (shared) is "bank 0,1,2 & 3" STATUS @ h'03' / bit mask in register is set from BSF as 1 in RP0 = h'05').
        movlw   b'11110000'
        movwf     TRISC             ;Make i/o pin TRISC0 an output. Tristate register for i/o. (bcf = "bit clear f" set bit in defined register to 0 / register is "bank 1" TRISC @ h'fe' / bit mask in register is set from BSC as 0 in TRISC0 @ h'00'.
...
;        bcf     PORTC,1
        ...
        movwf     TRISC             ;Make i/o pin TRISC0 an output. Tristate register for i/o. (bcf = "bit clear f" set bit in defined register to 0 / register is "bank 1" TRISC @ h'fe' / bit mask in register is set from BSC as 0 in TRISC0 @ h'00'.
        bcf     STATUS,RP0
        bsf     PORTC,2             ;Turn on LED @ TRISC0.
;        bcf     PORTC,2
        bsf     STATUS,RP0          ;Select register page 1 (bsf = "bit set f" set bit in defined register to 1 / register (shared) is "bank 0,1,2 & 3" STATUS @ h'03' / bit mask in register is set from BSF as 1 in RP0 = h'05').
        movlw   b'11110000'
        movwf     TRISC             ;Make i/o pin TRISC0 an output. Tristate register for i/o. (bcf = "bit clear f" set bit in defined register to 0 / register is "bank 1" TRISC @ h'fe' / bit mask in register is set from BSC as 0 in TRISC0 @ h'00'.
