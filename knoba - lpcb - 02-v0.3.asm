...
loop_01
        ;Long loop.
				;Delay by 768 instructions = 768us (1 instruction = 1us = 0.000,001s).

				;= 1 instruction x 256 loops.
        decfsz  Delay,f         ;Decrement "Delay" (.256 = .0) by 1 (.255). Skip when "Delay" = 0.

				;= 2 instructions x 256 loops.
        goto    loop_01         ;Go back to "loop_01" and decfsz again.
				;= 3 instructions total. 768 instructions for this goto loop.
        ...
        goto    loop_01         ;Go back to "loop_01" and decfsz again.
				...
				;Total loop time (768 x 768) is 0.589,824s = 589,824 instructions.
...
loop_09
        ;Long loop.
        decfsz  Delay,f         ;Decrement "Delay" (.256 = .0) by 1 (.255). Skip when "Delay" = 0.
        goto    loop_09         ;Go back to "loop_01" and decfsz again.
        decfsz  Delay1,f        ;Decrement "Delay1" (.256 = .0) by 1 (.255). Skip when "Delay" = 0.
        goto    loop_09         ;Go back to "loop_01" and decfsz again.
...
loop_10
        ;Long loop.
        decfsz  Delay,f         ;Decrement "Delay" (.256 = .0) by 1 (.255). Skip when "Delay" = 0.
        goto    loop_10         ;Go back to "loop_02" and decfsz again.
        decfsz  Delay1,f        ;Decrement "Delay1" (.256 = .0) by 1 (.255). Skip when "Delay" = 0.
        goto    loop_10         ;Go back to "loop_02" and decfsz again.
...
loop_11
        ;Long loop.
        decfsz  Delay,f         ;Decrement "Delay" (.256 = .0) by 1 (.255). Skip when "Delay" = 0.
        goto    loop_11         ;Go back to "loop_01" and decfsz again.
        decfsz  Delay1,f        ;Decrement "Delay1" (.256 = .0) by 1 (.255). Skip when "Delay" = 0.
        goto    loop_11         ;Go back to "loop_01" and decfsz again.
...
loop_12
        ;Long loop.
        decfsz  Delay,f         ;Decrement "Delay" (.256 = .0) by 1 (.255). Skip when "Delay" = 0.
        goto    loop_12         ;Go back to "loop_02" and decfsz again.
        decfsz  Delay1,f        ;Decrement "Delay1" (.256 = .0) by 1 (.255). Skip when "Delay" = 0.
        goto    loop_12         ;Go back to "loop_02" and decfsz again.
